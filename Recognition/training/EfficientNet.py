...
OUT_PUT_MODEL_FT = '/root/Recognition/models/efficientnet.pth'  # 微调后的模型保存路径
EPOCHS = 75
BATCH_SIZE = 16
...
def plot_training(history):
    ...
    plt.legend()
    plt.grid()
    plt.savefig("/root/Recognition/figs/EfficientNet/accuracy.png")
    ...
    plt.legend()
    plt.grid()
    plt.savefig("/root/Recognition/figs/EfficientNet/loss.png")
    ...
    plt.legend()
    plt.grid()
    plt.savefig("/root/Recognition/figs/EfficientNet/f1_score.png")
