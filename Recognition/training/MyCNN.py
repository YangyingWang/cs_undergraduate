...
OUT_PUT_MODEL_FT = '/root/Recognition/models/mycnn.pth'  # 微调后的模型保存路径
EPOCHS = 75
BATCH_SIZE = 16
...
class MyCNN(nn.Module):
    def __init__(self, num_classes):
        ...
        # 定义全连接层
        self.fc1 = nn.Linear(in_features=128 * 28 * 28, out_features=256)  # 假设输入为 224x224 图像
...
def plot_training(history):
    ...
    plt.legend()
    plt.grid()
    plt.savefig("/root/Recognition/figs/ResNet50(1)/accuracy.png")
    ...
    plt.legend()
    plt.grid()
    plt.savefig("/root/Recognition/figs/ResNet50(1)/loss.png")
    ...
    plt.legend()
    plt.grid()
    plt.savefig("/root/Recognition/figs/ResNet50/f1_score.png")
