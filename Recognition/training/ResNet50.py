...
OUT_PUT_MODEL_FT = '/root/Recognition/models/resnet50(2).pth'  # 微调后的模型保存路径
EPOCHS = 150
BATCH_SIZE = 32
...
def plot_training(history):
    ...
    plt.legend()
    plt.grid()
    plt.savefig("/root/Recognition/figs/ResNet50(2)/accuracy.png")
    ...
    plt.legend()
    plt.grid()
    plt.savefig("/root/Recognition/figs/ResNet50(2)/loss.png")
    ...
    plt.legend()
    plt.grid()
    plt.savefig("/root/Recognition/figs/ResNet50(2)/f1_score.png")
